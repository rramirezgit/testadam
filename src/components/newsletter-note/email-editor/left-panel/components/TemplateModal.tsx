...
export default function TemplateModal({
  ...
  // Si está en modo AI, solo mostrar 'news'
  ...
  const handleAccept = () => {
    if (selectedTemplate) {
      ...
      if (isAICreation) {
        // En modo AI, abrir el modal de IA después de seleccionar template
        setOpenAIModal(true);
      } else {
        // En modo normal, simplemente cerrar
        onClose();
      }
    }
  };
  ...
  const handleAIModalClose = () => {
    ...
    onClose(); // También cerrar el TemplateModal
  };
  ...
  return (
    <>
      ...
      {/* Modal de IA - Se abre después de seleccionar template en modo AI */}
      {isAICreation && (
        <AINoteModal
          open={openAIModal}
