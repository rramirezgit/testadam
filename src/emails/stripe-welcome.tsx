...
export const StripeWelcomeEmail = ({
  mainText = "Thanks for submitting your account information. You're now ready to make live transactions with Stripe!",
  dashboardText = "You can view your payments and a variety of other information about your account right from your dashboard.",
  buttonText = "View your Stripe Dashboard",
  signatureText = "— The Stripe team",
    ...
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          <Text style={paragraph}>{dashboardText}</Text>
          ...
          <Text style={paragraph}>{signatureText}</Text>
          <Hr style={hr} />
